...
- Remaining: expand real external endpoint research with user confirmation/source attribution, then add broader command coverage on top of the safe executor.
