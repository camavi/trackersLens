...
| 15 | DevTools | Parziale avanzato | `devtools.html`, `js/devtoolsView.js`, `css/devtools.css`, `core/runtime/devtools-runtime.js`, `docs/devtools-runtime.md`, Database, Connections, Analytics, AI Center, Monitor e Flow Map come basi DevTools; loader runtime unificato; tab Overview, Graph, Offline, Packages, Time Travel e Performance. | Aggiungere tab Events, Channels, AI e deep link da Flow Map/Analytics. |
