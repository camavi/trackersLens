...
- 2026-05-25: I flow log della Flow Map vengono ora riflessi subito nello stato runtime in memoria e i test Pulse/Live aprono automaticamente il pannello `Flow logs`, rendendo visibili gli stati connect/open/message/error senza reload.
